...
export default class RegistrationForm {
    constructor() {
        this._csrf = document.querySelector('[name="_csrf"]').value //store csrf value for our register form
        this.form = document.querySelector("#registration-form")
        this.allFields = document.querySelectorAll("#registration-form .form-control") //returns array for username, pass, email
        this.insertValidationElements()
        this.username = document.querySelector("#username-register")
        this.username.previousValue = "" //set up to ignore certain keypresses from calling live validation
    ...
    isDifferent(el, handler) {
        // ensure the handler doesn't run unless the text in input changes (i.e. ignores arrow keys, tab, shift, ctrl keys, etc in form)
        if (el.previousValue != el.value) {
            handler.call(this) //set this to overall object
        }
    ...
    usernameHandler() {
       ...
       //set timer to give user some time to type key strokes before error messages appear
    }
    ...
    emailAfterDelay() {
        //evaluates for true when text@text
    ...
    usernameImmediately() {
        //make sure username only contains letters and numbers using RegEX
